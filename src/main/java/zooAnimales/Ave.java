...
public class Ave extends Animal {
	...
	public Ave crearHalcon(String nombre_nuevo, int edad_nueva, String genero_nuevo) {
		Ave halcon = new Ave(nombre_nuevo, edad_nueva, "montanas", genero_nuevo, "cafe glorioso");
		halcones++;
		return halcon;
	}
	
	public Ave crearAguila(String nombre_nuevo, int edad_nueva, String genero_nuevo) {
