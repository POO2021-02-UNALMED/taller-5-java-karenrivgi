...
public class Pez extends Animal {
	...
	public Pez crearSalmom(String nombre_nuevo, int edad_nueva, String genero_nuevo) {
		Pez salmon = new Pez(nombre_nuevo, edad_nueva, "oceano", genero_nuevo, "rojo", 6);
		salmones++;
		return salmon;
	}
	
	public Pez crearBacalao(String nombre_nuevo, int edad_nueva, String genero_nuevo) {
