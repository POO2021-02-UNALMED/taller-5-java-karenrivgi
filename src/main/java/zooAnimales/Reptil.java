...
public class Reptil extends Animal {
	...
	public Reptil crearIguana(String nombre_nuevo, int edad_nueva, String genero_nuevo) {
		Reptil iguana = new Reptil(nombre_nuevo, edad_nueva, "humedal", genero_nuevo, "verde", 3);
		iguanas++;
		return iguana;
	}
	
	public Reptil crearSerpiente(String nombre_nuevo, int edad_nueva, String genero_nuevo) {
